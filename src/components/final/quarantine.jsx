      ...
      <Stack>
        ...
        <Text>
          <UnorderedList>
            ...
            {age > 1 && (
              <ListItem>
                Beutazás előtt kötelező egy 24 óránál nem régebbi antigén gyorsteszt vagy PCR teszt.
                A mintavétel ideje számít.
              </ListItem>
            )}
            <ListItem>
        ...
        <Text>
          <UnorderedList>
            ...
            <ListItem>
              A beutazást követő 3. napon lehetőség van egy PCR teszt elvégzésére, melynek negatív
              eredményével véget érhet a karantén.
            </ListItem>
            <ListItem>
              A beutazás napja a 0. nap, az eredmény pedig a teszt elvégzése után 24-72 órán belül
              van meg.
            </ListItem>
          </UnorderedList>
        </Text>
